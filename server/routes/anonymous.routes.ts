 ...
 * 
 * This file contains routes specifically for anonymous user session management
 * and is mapped to /api/anonymous/* in the main routes index.
 * 
 * It complements the other authentication systems (Supabase auth and demo auth)
 * by providing functionality for users who haven't registered yet.
 */
const router = Router();
