...
export interface IStorage {
  ...
  searchVideos(userInfo: { user_id?: number | null, anonymous_session_id?: string | null }, params: SearchParams): Promise<{ videos: Video[], totalCount: number, hasMore: boolean, nextCursor?: number }>;
