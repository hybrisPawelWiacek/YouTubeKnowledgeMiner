  ...
  return (
    <section className="my-12">
      <div className="max-w-3xl mx-auto text-center py-12">
        ...
        <h2 className="text-2xl font-bold mb-2">Welcome to YouTube Buddy</h2>
        <p className="text-gray-400 mb-6 max-w-md mx-auto">
          Easily analyze YouTube videos, extract transcripts, and build your personal video library.
        </p>
